...
export const antiCausalEdgeConfigSchema = z
  .object({
    enabled: z.boolean(),
...
export const chapterOrderContestedSchema = z
  .object({
...
export const surfaceModeConfigSchema = z
  .object({
    enabled: z.boolean(),
  })
  .strict();

export const causalOverloadConfigSchema = z
  .object({
    enabled: z.boolean(),
...
export const modernNovelConfigSchema = z
  .object({
