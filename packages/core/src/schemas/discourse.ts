...
export const audienceSemanticsSchema = z
  .object({
...
export const narrationDisclosurePolicySchema = z
  .object({
...
export const initialExposureContractSchema = z
  .object({
...
export const modelReaderProfileSchema = z
  .object({
...
export const diegeticRelationSchema = z.enum(['heterodiegetic', 'homodiegetic']);
...
export const narratorTruthCapabilitySchema = z.enum([
  'full_knowledge',
  'limited_knowledge',
  'opaque',
]);
...
export const focalizerBoundProfileSchema = narratorProfileBaseSchema
  .extend({
    type: z.literal('focalizer_bound'),
  })
  .strict();

export const retrospectiveEntityProfileSchema = narratorProfileBaseSchema
  .extend({
...
export const explicitLedgerProfileSchema = narratorProfileBaseSchema
  .extend({
    type: z.literal('explicit_ledger'),
  })
  .strict();

export const omniscientProfileSchema = narratorProfileBaseSchema
  .extend({
...
export const assertionEvidenceSchema = z
  .object({
    type: z.enum([
      'direct_observation',
      'testimony',
...
export const narratorAssertionSchema = z
  .object({
    id: z.string(),
    narrator: z.string(),
...
export const revealActionSchema = z
  .object({
...
export const claimActionSchema = z
  .object({
...
export const hintActionSchema = z
  .object({
    type: z.literal('hint'),
    hintId: z.string(),
...
export const retractionActionSchema = z
  .object({
...
export const correctionActionSchema = z
  .object({
...
export const withholdStartActionSchema = z
  .object({
...
export const withholdEndActionSchema = z
  .object({
...
export const withholdingPolicySchema = z
  .object({
    policyId: z.string(),
    reason: z.string().optional(),
...
export const discourseContextProjectionSchema = z
  .object({
    plannedReveals: z.array(z.string()),
    openClaims: z.array(z.string()),
    visibleHints: z.array(
      z
        .object({
          hintId: z.string(),
          surfaceProposition: z.string(),
...
export const disclosureObservationSchema = z
  .object({
...
export const discourseCacheKeySchema = z
  .object({
    runKey: z.string(),
    cursor: z.string(),
...
export const validationKeySchema = z
  .object({
    proseHash: z.string(),
...
export const anachronySchema = z
  .object({
