...
**前置审计：** `docs/audits/stage-1.5v2-audit-2026-07-24.md`（结构健康）、`docs/report/stage-1.5v2-acceptance-2026-07-22.md`（分波交付）、`docs/report/stage-1.5v3-acceptance-2026-07-24.md`（审计修复）。
...
- 前置审计：`docs/audits/stage-1.5v2-audit-2026-07-24.md`
- V2 验收：`docs/report/stage-1.5v2-acceptance-2026-07-22.md`
- V3 验收：`docs/report/stage-1.5v3-acceptance-2026-07-24.md`
- 源规范：`docs/TODO.md`
