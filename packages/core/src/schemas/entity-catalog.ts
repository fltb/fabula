...
export const entityTypeRefSchema = z.object({
  typeId: z.string(),
...
export const writePolicySchema = z.enum(['immutable', 'write_once', 'mutable', 'lifecycle_managed']);
...
export const attributeDefinitionSchema = z.object({
  ...
  typedReferenceConstraint: z.object({
    targetKind: z.string(),
...
export const entityTypeDefinitionSchema = z.object({
  ...
  typedInvariants: z.array(z.object({
    id: z.string(),
...
export const entityTypeCatalogSchema = z.object({
...
export const entityDeclarationCatalogSchema = z.object({
