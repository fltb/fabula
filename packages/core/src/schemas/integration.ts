...
export const absenceWitnessSchema = z.object({
  branch: z.object({
    decisions: z.array(
      z.object({
        atEventId: z.string(),
...
export const readResolutionUnionSchema = z.union([
  providerOutputSchema,
...
export const mergePlanProvenanceSchema = z.object({
  sourceBranch: z.object({
    decisions: z.array(
      z.object({
        atEventId: z.string(),
        choiceId: z.string(),
...
export const discourseBridgeSchema = z.object({
  id: z.string(),
  position: z.number(),
  plannedActs: z.array(z.string()),
  provenance: z.string(),
...
export const discourseNodeSchema = z.union([
...
export const storySnapshotTombstonesSchema = z.object({
...
export const storySnapshotCatalogHashesSchema = z.object({
...
export const discourseSnapshotSchema = z.object({
  assemblyId: z.string(),
  branch: z.object({
    decisions: z.array(
      z.object({
